    ...
    <SectionWrapper id="services" className="bg-background">
      <div className="text-center mb-12 md:mb-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          Мы предлагаем полный спект верхних решений для трансформации вашего бизнеса с помощью искусственного интеллекта.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service) => (
          <Card key={service.title} className="flex flex-col hover:shadow-xl transition-shadow duration-300 rounded-lg overflow-hidden">
